...
export function GeneratorForm({ kind, titleKey, descriptionKey }: { kind: GeneratorKind; titleKey: MessageKey; descriptionKey: MessageKey }) {
  ...
  function submit(data: FormData) {
    ...
    const content = kind === "function" ? createFunctionPrompt(values) : kind === "debug" ? createDebugPrompt(values) : createSystemCheckPrompt(values);
    setResult(content);
  }
  function download() {
